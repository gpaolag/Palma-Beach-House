...
Description: Addition hook filter for pergo theme
Author: ThemePerch
...
define( 'PERCH_MODULES_VERSION', '1.0.6' );

define( 'PERCH_MODULES_REQUIRED_WP_VERSION', '5.2' );
...
function perch_vc_image_upload_settings_field($settings, $value){
  return '<div class="perch-upload-container">
      <input type="text" name="' . esc_attr( $settings['param_name'] ) . '" value="'.esc_url($value).'" class="wpb_vc_param_value wpb-textinput perch-generator-attr perch-generator-upload-value perch-upload-value" />
...
function perch_modules_supported_themes(){
    return array( 'Genemy', 'Pergo', 'Appset', 'Landpick' );
}
...
require_once PERCH_MODULES_DIR . '/headers-and-footers-scripts/headers-and-footers-scripts.php'; 