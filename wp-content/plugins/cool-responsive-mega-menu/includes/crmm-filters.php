...
function crmm_nav_menu_css_class_callback( $classes, $item, $args, $depth ){ 
    ...
    if($pcool_options){ 
        if(isset($pcool_options['cool_megamenu_display']) && $pcool_options['cool_megamenu_display'] == 'on'){
            $classes[] = !empty($cool_options['megamenu_column'])? $cool_options['megamenu_column'] : 'col';
        }        
    }   
...
function crmm_walker_nav_menu_start_el_callback($item_output, $item, $depth, $args){
  ...
  if( isset($pcool_options['cool_megamenu_display']) && ($pcool_options['cool_megamenu_display'] == 'on')){
      if( empty($cool_options['second_level_settings']) || $cool_options['second_level_settings'] == 'off' ) return $item_output;
      if( empty($cool_options['megamenu_item_type']) || $cool_options['megamenu_item_type'] == '' ) return $item_output;     
