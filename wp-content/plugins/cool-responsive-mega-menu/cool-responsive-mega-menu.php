...
define( 'COOL_MEGAMENU_UPDATE_DATE', '23th August, 2022' );
...
if ( ! class_exists( 'Cool_Megamenu_Loader' ) ) {
  ...
  class Cool_Megamenu_Loader {
    ...
    public function add_list_item() {
      ...
      crmm_list_item_view( $_REQUEST['name'], $_REQUEST['count'], array(), $_REQUEST['post_id'], $_REQUEST['get_option'], crmm_decode( $_REQUEST['settings'] ), $_REQUEST['type'] );
      die();
    }
    ...
    public function add_social_links() {
      check_ajax_referer( 'cool_megamenu', 'nonce' );
      crmm_social_links_view( $_REQUEST['name'], $_REQUEST['count'], array(), $_REQUEST['post_id'], $_REQUEST['get_option'], crmm_decode( $_REQUEST['settings'] ), $_REQUEST['type'] );
      die();
    }
