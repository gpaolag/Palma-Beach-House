<?php
add_action( 'vc_load_default_templates_action','pergo_startup_1_template_for_vc' ); // Hook in
function pergo_startup_1_template_for_vc() {
    $data               = array(); // Create new array
    $data['name']       = __( 'Template: 05 - Startup 1', 'pergo' ); // Assign name for your custom template
    $data['weight']     = 0; 
    $data['image_path'] = '';
    $data['custom_class'] = ''; // CSS class name
    $data['content']    = <<<CONTENT
    [vc_section padding_class="wide-0"][vc_row][vc_column][pergo_hero_startup1 params="%5B%7B%22icon%22%3A%22fa%20fa-angle-double-right%22%2C%22button_text%22%3A%22Our%20Latest%20Projects%22%2C%22button_url%22%3A%22%23portfolio%22%2C%22button_target%22%3A%22_self%22%2C%22button_style%22%3A%22btn-tra-white%22%2C%22button_size%22%3A%22btn-md%22%7D%5D" id="780"][/vc_column][/vc_row][/vc_section][vc_section padding_class="wide-0" el_id="about"][vc_row][vc_column][vc_empty_space height="100px"][pergo_section_title title=""][vc_row_inner][vc_column_inner width="1/12"][/vc_column_inner][vc_column_inner width="5/12"][pergo_service_box icon="flaticon-wireless-internet" title="Market Research" css_animation="fadeInUp"][pergo_service_box css_animation="fadeInUp" animation_delay="500"][/vc_column_inner][vc_column_inner width="5/12"][pergo_service_box icon="flaticon-users" title="User Experience" css_animation="fadeInUp" animation_delay="400"][pergo_service_box icon="flaticon-help" title="Free Consultations" css_animation="fadeInUp" animation_delay="600"][/vc_column_inner][vc_column_inner width="1/12"][/vc_column_inner][/vc_row_inner][/vc_column][/vc_row][/vc_section][vc_section full_width="container-wide" padding_class="wide-0" el_id="why-pergo"][vc_row][vc_column][vc_empty_space height="20px"][pergo_digital_strategy display_style="content-6" image="http://jthemes.org/wp/pergo/files/images/content-6-img.png" subtitle="About Pergo" title="We use design and innovations" display="techs" techs_group="%5B%7B%22title%22%3A%22HTML5%22%2C%22icon%22%3A%22fa%20fa-html5%22%7D%2C%7B%22title%22%3A%22CSS3%22%2C%22icon%22%3A%22fa%20fa-css3%22%7D%2C%7B%22title%22%3A%22JavaScripts%22%2C%22icon%22%3A%22fa%20fa-github-alt%22%7D%2C%7B%22title%22%3A%22PHP%22%2C%22icon%22%3A%22fa%20fa-free-code-camp%22%7D%2C%7B%22title%22%3A%22WordPress%22%2C%22icon%22%3A%22fa%20fa-wordpress%22%7D%2C%7B%22title%22%3A%22Sass%22%2C%22icon%22%3A%22fa%20fa-mixcloud%22%7D%5D"]<!-- Text -->
...
integer congue magna pretium purus pretium ligula rutrum luctus risus ultrice luctus</p>
[/pergo_digital_strategy][/vc_column][/vc_row][/vc_section][vc_section padding_class="wide-0" el_id="how-it-works"][vc_row][vc_column][vc_empty_space height="50px"][pergo_digital_strategy display_style="content-6" image="http://jthemes.org/wp/pergo/files/images/content-5-img.png" position="yes" display="counter" counter_group="%5B%7B%22title%22%3A%22Happy%20Clients%22%2C%22count%22%3A%221154%22%7D%2C%7B%22title%22%3A%22Tickets%20Closed%22%2C%22count%22%3A%22409%22%7D%5D"]<!-- Text -->
...
[/pergo_digital_strategy][vc_empty_space height="50px"][/vc_column][/vc_row][/vc_section][vc_section full_width="container-wide" el_id="what-you-will-get"][vc_row full_width="stretch_row_content_no_spaces"][vc_column][pergo_digital_strategy strategy_list="%5B%7B%22title%22%3A%22Fully%20Responsive%20Design%22%7D%2C%7B%22title%22%3A%22Bootstrap%204.0%20Based%22%7D%2C%7B%22title%22%3A%22Google%20Analytics%20Ready%22%7D%2C%7B%22title%22%3A%22Cross%20Browser%20Compatability%22%7D%2C%7B%22title%22%3A%22Developer%20Friendly%20Commented%20Code%22%7D%2C%7B%22title%22%3A%22and%20much%20more%E2%80%A6%22%7D%5D"]An enim tempor sapien gravida donec ipsum blandit porta justo integer odio velna vitae auctor integer congue magna pretium purus pretium ligula rutrum luctus risus ultrice luctus[/pergo_digital_strategy][/vc_column][/vc_row][/vc_section][vc_section parallax="content-moving" parallax_image="http://jthemes.org/wp/pergo/files/images/tra-bg.png" bg_class="bg-purple" parallax_image_repeat="" parallax_image_position="50% 0" parallax_image_attachment="fixed" el_id="pricing-2-title" el_class="white-color"][vc_row][vc_column][pergo_section_title title="Pricing Plans For Everyone" tag="h2:h2-xs"][/vc_column][/vc_row][/vc_section][vc_section padding_class="wide-0" bg_class="bg-tra" el_id="pricing-2-content"][vc_row][vc_column width="1/3"][pergo_pricing_table animation_delay="300"]
<ul class="features">
...
[/pergo_pricing_table][/vc_column][vc_column width="1/3"][pergo_pricing_table featured="yes" price="99" animation_delay="300"]
<ul class="features">
...
[/pergo_pricing_table][/vc_column][vc_column width="1/3"][pergo_pricing_table price="99" animation_delay="300"]
<ul class="features">
