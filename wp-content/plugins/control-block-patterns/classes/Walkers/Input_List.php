<?php
namespace ControlPatterns\Walkers;
...
class Input_List extends Base {
	...
	public function start_lvl( &$output, $depth = 0, $args = array() ) {
		$output .= '<ul class="ctrlbp-input-list">';
	}
	...
	public function start_el( &$output, $object, $depth = 0, $args = array(), $current_object_id = 0 ) {
		$attributes = Field::call( 'get_attributes', $this->field, $object->value );
