...
class Loader {
	public function __construct() {
		...
		add_filter( 'ctrlbp_meta_type', array( $this, 'filter_meta_type' ), 10, 3 );
	}

	private function register_settings_pages() {

		$settings_pages = ctrlbp_settings_pages();
		if( current_theme_supports( 'control-block-patterns' ) ){
			$settings_pages = apply_filters( 'ctrlbp_settings_pages', $settings_pages );
		}
