 ...
 */
abstract class Object_Choice extends Choice {
	/**
	 * Show field HTML.
	...
	public static function show( $field, $saved, $post_id = 0 ) {
		...
		$meta = Helpers_Array::flatten( (array) $meta );
	...
	public static function get_attributes( $field, $value = null ) {
		...
		if ( 'select_advanced' === $field['field_type'] ) {
			$attributes['class'] .= ' ctrlbp-select_advanced';
		} elseif ( 'select' === $field['field_type'] ) {
			$attributes['class'] .= ' ctrlbp-select';
		}
		return $attributes;
	}
	...
	public static function admin_enqueue_scripts() {
		Input_List::admin_enqueue_scripts();
		Select::admin_enqueue_scripts();
		Select_Tree::admin_enqueue_scripts();
		Select_Advanced::admin_enqueue_scripts();
	}
	...
	protected static function get_type_class( $field ) {
		return Helpers_Field::get_class(
			array(
