...
abstract class Input extends Field {
	...
	public static function html( $meta, $field ) {
		...
		if ( $field['prepend'] || $field['append'] ) {
			$output = '<div class="ctrlbp-input-group">';
		}

		if ( $field['prepend'] ) {
			$output .= '<span class="ctrlbp-input-group-text">' . $field['prepend'] . '</span>';
		}
		...
		if ( $field['append'] ) {
			$output .= '<span class="ctrlbp-input-group-text">' . $field['append']. '</span>';
		}
