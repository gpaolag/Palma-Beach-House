...
class Image extends File {
	...
	protected static function file_html( $file, $index, $field ) {
		...
		if ( $edit_link ) {
			$edit_link = sprintf( '<a href="%s" class="ctrlbp-image-edit" target="_blank"><span class="dashicons dashicons-edit"></span></a>', $edit_link );
		}

		return sprintf(
			'<li class="ctrlbp-image-item">
				<div class="ctrlbp-file-icon">%s</div>
				<div class="ctrlbp-image-overlay"></div>
				<div class="ctrlbp-image-actions">
					%s
					<a href="#" class="ctrlbp-image-delete ctrlbp-file-delete" data-attachment_id="%s"><span class="dashicons dashicons-no-alt"></span></a>
				</div>
