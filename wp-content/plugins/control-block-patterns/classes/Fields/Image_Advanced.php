 ...
 */
class Image_Advanced extends Media {
	/**
	...
	public static function admin_enqueue_scripts() {
		...
		wp_enqueue_script( 'ctrlbp-image-advanced', CTRLBP_JS_URI . 'image-advanced.js', array( 'ctrlbp-media' ), CTRLBP_VER, true );
	}
	...
	public static function file_info( $file, $args = array(), $field = array() ) {
		return Image::file_info( $file, $args, $field );
	}
	...
	public static function format_single_value( $field, $value, $args, $post_id ) {
		return Image::format_single_value( $field, $value, $args, $post_id );
	}
	...
	public static function print_templates() {
		...
		require_once CTRLBP_INC_DIR . 'templates/image-advanced.php';
	}
}
