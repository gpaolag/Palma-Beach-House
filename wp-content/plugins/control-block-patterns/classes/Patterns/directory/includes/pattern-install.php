 ...
 * @return array
 */
function install_patterns_feature_list() {
 ...
 */
function install_patterns_search_form( $type_selector = true ) {
 ...
 * @since 2.8.0
 */
function install_patterns_dashboard() {
...
<br class="clear" />
	<?php submit_button( __( 'Find Patterns' ), '', 'search' ); ?>
</form>
	<?php
}
 ...
 * @since 2.8.0
 */
function install_patterns_upload() {
	?>
...
function display_pattern( $pattern ) {
	...
	$wp_list_table = new CBP_Pattern_Install_List_Table();
	$wp_list_table->single_row( $pattern );
}
 ...
 * @global WP_Theme_Install_List_Table $wp_list_table
 */
function install_pattern_information() {
	$wp_list_table = new CBP_Pattern_Install_List_Table();
