...
class Meta_Box_Registry {
	...
	public function make( $settings ) {
		$class_name = apply_filters( 'ctrlbp_meta_box_class_name', __NAMESPACE__ . '\Meta_Box', $settings );
	 ...
	 *
	 * @param Meta_Box $meta_box Meta box instance.
	 */
	 ...
	 *
	 * @return CTRLBP_Meta_Box|bool False or meta box object.
	 */
