...
use ControlPatterns\Fields\Choice as Choice;
/**
...
class Sanitizer {
	...
	public function init() {
		add_filter( 'ctrlbp_sanitize', array( $this, 'sanitize' ), 10, 4 );
	}
	 ...
	 *
	 * @link https://github.com/rilwis/control-block-patterns/issues/6
	...
	private function sanitize_choice( $value, $field ) {
		$options = Choice::transform_options( $field['options'] );
	...
	private function sanitize_taxonomy_advanced( $value ) {
		$value = Helpers\Array_Type::from_csv( $value );
