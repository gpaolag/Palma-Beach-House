    ...
    echo '<form method="post" id="option-tree-settings-form">';
      ...
      echo '<div class="format-setting type-textblock has-desc">';
        ...
        echo '<div class="description">';
          ...
          echo '<h4>'. __( 'Warning!', 'pergo' ) . '</h4>';

          echo '<p class="warning">' . sprintf( __( 'Go to the %s page if you want to save data, this page is for adding settings.', 'pergo' ), '<a href="' . get_admin_url( $blog_id, apply_filters( 'ot_theme_options_parent_slug', 'themes.php' ) . '?page=' . apply_filters( 'ot_theme_options_menu_slug', 'ot-theme-options' ) ) . '"><code>Appearance->Theme Options</code></a>' ) . '</p>';

          echo '<p class="warning">' . sprintf( __( 'If you\'re unsure or not completely positive that you should be editing these settings, you should read the %s first.', 'pergo' ), '<a href="' . get_admin_url( $blog_id, 'admin.php?page=ot-documentation' ) . '"><code>OptionTree->Documentation</code></a>' ) . '</p>';

          echo '<h4>'. __( 'Things could break or be improperly displayed to the end-user if you do one of the following:', 'pergo' ) . '</h4>';

          echo '<p class="warning">' . __( 'Give two sections the same ID, give two settings the same ID, give two contextual help content areas the same ID, don\'t create any settings, or have a section at the end of the settings list.', 'pergo' ) . '</p>';

          echo '<p>' . __( 'You can create as many settings as your project requires and use them how you see fit. When you add a setting here, it will be available on the Theme Options page for use in your theme. To separate your settings into sections, click the "Add Section" button, fill in the input fields, and a new navigation menu item will be created.', 'pergo' ) . '</p>';

          echo '<p>' . __( 'All of the settings can be sorted and rearranged to your liking with Drag & Drop. Don\'t worry about the order in which you create your settings, you can always reorder them.', 'pergo' ) . '</p>';
        ...
        echo '<div class="format-setting-inner">';
          ...
          echo '<a href="javascript:void(0);" class="option-tree-section-add option-tree-ui-button button hug-left">' . __( 'Add Section', 'pergo' ) . '</a>';

          echo '<a href="javascript:void(0);" class="option-tree-setting-add option-tree-ui-button button">' . __( 'Add Setting', 'pergo' ) . '</a>';

          echo '<button class="option-tree-ui-button button button-primary right hug-right">' . __( 'Save Changes', 'pergo' ) . '</button>';
          ...
          <div class="format-setting-label" id="contextual-help-label">
            ...
            <h3 class="label">' . __( 'Contextual Help', 'pergo' ) . '</h3>
          ...
          <div class="format-settings" id="contextual-help-setting">
            ...
            <div class="format-setting type-textarea no-desc">
              ...
              <div class="description"><strong>' . __( 'Contextual Help Sidebar', 'pergo' ) . '</strong>: ' . __( 'If you decide to add contextual help to the Theme Option page, enter the optional "Sidebar" HTML here. This would be an extremely useful place to add links to your themes documentation or support forum. Only after you\'ve added some content below will this display to the user.', 'pergo' ) . '</div>
          ...
          echo '<a href="javascript:void(0);" class="option-tree-help-add option-tree-ui-button button hug-left">' . __( 'Add Contextual Help Content', 'pergo' ) . '</a>';
    ...
    echo '<form method="post" id="import-xml-form">';
      ...
      echo '<div class="format-setting type-textblock has-desc">';
        ...
        echo '<div class="description">';
          ...
          echo '<p class="deprecated">' . __( 'This import method has been deprecated. That means it has been replaced by a new method and is no longer supported, and may be removed from future versions. All themes that use this import method should be converted to use its replacement below.', 'pergo' ) . '</p>';

          

          echo '<p>' . sprintf( __( 'If you were given a Theme Options XML file with a premium or free theme, locate it on your hard drive and upload that file by clicking the upload button. A popup window will appear, upload the XML file and click "%s". The file URL should be in the upload input, if it is click "Import XML".', 'pergo' ), apply_filters( 'ot_upload_text', __( 'Send to OptionTree', 'pergo' ) ) ) . '</p>';

          

          /* button */

          echo '<button class="option-tree-ui-button button button-primary right hug-right">' . __( 'Import XML', 'pergo' ) . '</button>';
        ...
        echo '<div class="format-setting-inner">';
          ...
          echo '<div class="option-tree-ui-upload-parent">';
            ...
            echo '<a href="javascript:void(0);" class="ot_upload_media option-tree-ui-button button button-primary light" rel="' . $post_id . '" title="' . __( 'Add XML', 'pergo' ) . '"><span class="icon ot-icon-plus-circle"></span>' . __( 'Add XML', 'pergo' ) . '</a>';
    ...
    echo '<form method="post" id="import-settings-form">';
      ...
      echo '<div class="format-setting type-textarea has-desc">';
        ...
        echo '<div class="description">';
          ...
          echo '<p>' . __( 'To import your Settings copy and paste what appears to be a random string of alpha numeric characters into this textarea and press the "Import Settings" button.', 'pergo' ) . '</p>';

          

          /* button */

          echo '<button class="option-tree-ui-button button button-primary right hug-right">' . __( 'Import Settings', 'pergo' ) . '</button>';
    ...
    echo '<form method="post" id="import-data-form">';
      ...
      echo '<div class="format-setting type-textarea has-desc">';
        ...
        echo '<div class="description">';
          ...
          if ( OT_SHOW_SETTINGS_IMPORT ) echo '<p>' . __( 'Only after you\'ve imported the Settings should you try and update your Theme Options.', 'pergo' ) . '</p>';

          

          echo '<p>' . __( 'To import your Theme Options copy and paste what appears to be a random string of alpha numeric characters into this textarea and press the "Import Theme Options" button.', 'pergo' ) . '</p>';

          

          /* button */

          echo '<button class="option-tree-ui-button button button-primary right hug-right">' . __( 'Import Theme Options', 'pergo' ) . '</button>';
    ...
    echo '<form method="post" id="import-layouts-form">';
      ...
      echo '<div class="format-setting type-textarea has-desc">';
        ...
        echo '<div class="description">';
          ...
          if ( OT_SHOW_SETTINGS_IMPORT ) echo '<p>' . __( 'Only after you\'ve imported the Settings should you try and update your Layouts.', 'pergo' ) . '</p>';

          

          echo '<p>' . __( 'To import your Layouts copy and paste what appears to be a random string of alpha numeric characters into this textarea and press the "Import Layouts" button. Keep in mind that when you import your layouts, the active layout\'s saved data will write over the current data set for your Theme Options.', 'pergo' ) . '</p>';

          

          /* button */

          echo '<button class="option-tree-ui-button button button-primary right hug-right">' . __( 'Import Layouts', 'pergo' ) . '</button>';
    ...
    echo '<form method="post" id="export-settings-file-form">';
      ...
      echo '<div class="format-setting type-textarea simple has-desc">';
        ...
        echo '<div class="description">';
          ...
          echo '<p>' . sprintf( __( 'Export your Settings into a fully functional %s file. If you want to add your own custom %s text domain to the file, enter it into the text field before exporting. For more information on how to use this file read the documentation on %s. Remember, you should always check the file for errors before including it in your theme.', 'pergo' ), '<code>theme-options.php</code>', '<a href="http://codex.wordpress.org/I18n_for_WordPress_Developers" target="_blank">I18n</a>', '<a href="' . get_admin_url( $blog_id, 'admin.php?page=ot-documentation#section_theme_mode' ) . '">' . __( 'Theme Mode', 'pergo' ) . '</a>' ) . '</p>';
        ...
        echo '<div class="format-setting-inner">';
          ...
          echo '<button class="option-tree-ui-button button button-primary hug-left">' . __( 'Export Settings File', 'pergo' ) . '</button>';
    ...
    echo '<form method="post" id="option-tree-settings-form">';
      ...
      echo '<div class="format-setting type-textarea has-desc">';
        ...
        echo '<div class="description">';
          ...
          echo '<p>' . __( 'To add a new layout enter a unique lower case alphanumeric string (dashes allowed) in the text field and click "Save Layouts".', 'pergo' ) . '</p>';

          echo '<p>' . __( 'As well, you can activate, remove, and drag & drop the order; all situations require you to click "Save Layouts" for the changes to be applied.', 'pergo' ) . '</p>';

          echo '<p>' . __( 'When you create a new layout it will become active and any changes made to the Theme Options will be applied to it. If you switch back to a different layout immediately after creating a new layout that new layout will have a snapshot of the current Theme Options data attached to it.', 'pergo' ) . '</p>';

          if ( OT_SHOW_DOCS ) echo '<p>' . __( 'Visit <code>OptionTree->Documentation->Layouts Overview</code> to see a more in-depth description of what layouts are and how to use them.', 'pergo' ) . '</p>';
        ...
        echo '<div class="format-setting-inner">';
          ...
          echo '<button class="option-tree-ui-button button button-primary right hug-right">' . __( 'Save Layouts', 'pergo' ) . '</button>';
