  ...
  class OT_Meta_Box {
    ...
    function build_meta_box( $post, $metabox ) {
      ...
      echo '<div class="ot-metabox-wrapper">';
        ...
        echo isset( $this->meta_box['desc'] ) && ! empty( $this->meta_box['desc'] ) ? '<div class="description" style="padding-top:10px;">' . wpb_js_remove_wpautop( $this->meta_box['desc'] ) . '</div>' : '';
 ...
 * @uses     OT_Meta_Box()
 *
 * @param    array    Array of arestructuraents to create a meta box
 * @return   void
 *
 * @access   public
 * @since    2.0
