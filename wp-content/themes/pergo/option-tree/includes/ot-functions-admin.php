          ...
          array(
            ...
            'pages'               => array( 
              array(
                ...
                'page_title'      => apply_filters( 'ot_theme_options_page_title', __( 'Theme Options', 'pergo' ) ),
                'menu_title'      => apply_filters( 'ot_theme_options_menu_title', __( 'Theme Options', 'pergo' ) ),
                ...
                'updated_message' => apply_filters( 'ot_theme_options_updated_message', __( 'Theme Options updated.', 'pergo' ) ),
                'reset_message'   => apply_filters( 'ot_theme_options_reset_message', __( 'Theme Options reset.', 'pergo' ) ),
                'button_text'     => apply_filters( 'ot_theme_options_button_text', __( 'Save Changes', 'pergo' ) ),
  ...
  function ot_register_settings_page() {
    ...
    if ( OT_SHOW_OPTIONS_UI == true && isset( $_REQUEST['page'] ) && $_REQUEST['page'] == 'ot-settings' && ( $ot_has_custom_theme_options == true || has_action( 'admin_init', 'custom_theme_options' ) || has_action( 'init', 'custom_theme_options' ) ) ) {      
      ...
      function ot_has_custom_theme_options() {    
        ...
        echo '<div class="error"><p>' . __( 'The Theme Options UI Builder is being overridden by a custom file in your theme. Any changes you make via the UI Builder will not be saved.', 'pergo' ) . '</p></div>';        
    ...
    $ot_register_pages_array =  array( 
      ...
      array( 
        'id'              => 'ot',
        'page_title'      => __( 'OptionTree', 'pergo' ),
        'menu_title'      => __( 'OptionTree', 'pergo' ),
      ...
      array(
        ...
        'page_title'      => __( 'Settings', 'pergo' ),
        'menu_title'      => __( 'Settings', 'pergo' ),
        'capability'      => 'edit_theme_options',
        'menu_slug'       => 'ot-settings',
        'icon_url'        => null,
        'position'        => null,
        'updated_message' => __( 'Theme Options updated.', 'pergo' ),
        'reset_message'   => __( 'Theme Options reset.', 'pergo' ),
        'button_text'     => __( 'Save Settings', 'pergo' ),
        'show_buttons'    => false,
        'sections'        => array(
          array(
            'id'          => 'create_setting',
            'title'       => __( 'Theme Options UI', 'pergo' )
          ),
          array(
            'id'          => 'import',
            'title'       => __( 'Import', 'pergo' )
          ),
          array(
            'id'          => 'export',
            'title'       => __( 'Export', 'pergo' )
          ),
          array(
            'id'          => 'layouts',
            'title'       => __( 'Layouts', 'pergo' )
          )
        ),
        'settings'        => array(
          array(
            'id'          => 'theme_options_ui_text',
            'label'       => __( 'Theme Options UI Builder', 'pergo' ),
            'type'        => 'theme_options_ui',
            'section'     => 'create_setting'
          ),
          array(
            'id'          => 'import_xml_text',
            'label'       => __( 'Settings XML', 'pergo' ),
            'type'        => 'import-xml',
            'section'     => 'import'
          ),
          array(
            ...
            'label'       => __( 'Settings', 'pergo' ),
            'type'        => 'import-settings',
            'section'     => 'import'
          ),
          array(
            'id'          => 'import_data_text',
            'label'       => __( 'Theme Options', 'pergo' ),
            'type'        => 'import-data',
            'section'     => 'import'
          ),
          array(
            'id'          => 'import_layouts_text',
            'label'       => __( 'Layouts', 'pergo' ),
            'type'        => 'import-layouts',
            'section'     => 'import'
          ),
          array(
            'id'          => 'export_settings_file_text',
            'label'       => __( 'Settings PHP File', 'pergo' ),
          ...
          array(
            ...
            'label'       => __( 'Layout Management', 'pergo' ),
            'type'        => 'modify-layouts',
            'section'     => 'layouts'
          )
        )
      ...
      array(
        'id'              => 'documentation',
        'parent_slug'     => 'ot-settings',
        'page_title'      => __( 'Documentation', 'pergo' ),
        'menu_title'      => __( 'Documentation', 'pergo' ),
        'capability'      => 'edit_theme_options',
        ...
        'sections'        => array(
          array(
            'id'          => 'creating_options',
            'title'       => __( 'Creating Options', 'pergo' )
          ),
          array(
            'id'          => 'option_types',
            'title'       => __( 'Option Types', 'pergo' )
          ),
          array(
            'id'          => 'functions',
            'title'       => __( 'Function References', 'pergo' )
          ),
          array(
            'id'          => 'theme_mode',
            'title'       => __( 'Theme Mode', 'pergo' )
          ),
          array(
            'id'          => 'meta_boxes',
            'title'       => __( 'Meta Boxes', 'pergo' )
          ),
          array(
            'id'          => 'examples',
            'title'       => __( 'Code Examples', 'pergo' )
          ),
          array(
            'id'          => 'layouts_overview',
            'title'       => __( 'Layouts Overview', 'pergo' )
          )
        ),
        'settings'        => array(
          array(
            'id'          => 'creating_options_text',
            'label'       => __( 'Overview of available Theme Option fields.', 'pergo' ),
            'type'        => 'creating-options',
            'section'     => 'creating_options'
          ),
          array(
            'id'          => 'option_types_text',
            'label'       => __( 'Option types in alphabetical order & hooks to filter them.', 'pergo' ),
            'type'        => 'option-types',
            'section'     => 'option_types'
          ),
          array(
            'id'          => 'functions_ot_get_option',
            'label'       => __( 'Function Reference:ot_get_option()', 'pergo' ),
            'type'        => 'ot-get-option',
            'section'     => 'functions'
          ),
          array(
            'id'          => 'functions_get_option_tree',
            'label'       => __( 'Function Reference:get_option_tree()', 'pergo' ),
            'type'        => 'get-option-tree',
            'section'     => 'functions'
          ),
          array(
            'id'          => 'theme_mode_text',
            'label'       => __( 'Theme Mode', 'pergo' ),
            'type'        => 'theme-mode',
            'section'     => 'theme_mode'
          ),
          array(
            'id'          => 'meta_boxes_text',
            'label'       => __( 'Meta Boxes', 'pergo' ),
            'type'        => 'meta-boxes',
            'section'     => 'meta_boxes'
          ),
          array(
            'id'          => 'example_text',
            'label'       => __( 'Code examples for front-end development.', 'pergo' ),
            'type'        => 'examples',
            'section'     => 'examples'
          ),
          array(
            ...
            'label'       => __( 'What\'s a layout anyhow?', 'pergo' ),
    ...
    if ( 'background' == $type ) {
      ...
      foreach( $input as $key => $value ) {      
        ...
        if ( $key == 'width' && ! empty( $value ) && ! is_numeric( $value ) ) {         
          ...
          $input[$key] = '0';  
          add_settings_error( 'pergo', 'invalid_border_width', sprintf( __( 'The %s input field for %s only allows numeric values.', 'pergo' ), '<code>width</code>', '<code>' . $field_id . '</code>' ), 'error' );         
      ...
      if ( 0 === preg_match( '/^#([a-f0-9]{6}|[a-f0-9]{3})$/i', $input ) && 0 === preg_match( '/^rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9\.]{1,4})\s*\)/i', $input ) ) {       
        ...
        add_settings_error( 'pergo', 'invalid_hex', sprintf( __( 'The %s Colorpicker only allows valid hexadecimal or rgba values.', 'pergo' ), '<code>' . $field_id . '</code>' ), 'error' );     
      ...
      if ( isset( $errors ) ) {  
        foreach( $errors as $error ) { 
          $input[$error] = '0';
          add_settings_error( 'pergo', 'invalid_dimension_' . $error, sprintf( __( 'The %s input field for %s only allows numeric values.', 'pergo' ), '<code>' . $error . '</code>', '<code>' . $field_id . '</code>' ), 'error' );
        }
      }
      ...
      if ( isset( $errors ) ) {     
        foreach( $errors as $error ) {
          ...
          add_settings_error( 'pergo', 'invalid_spacing_' . $error, sprintf( __( 'The %s input field for %s only allows numeric values.', 'pergo' ), '<code>' . $error . '</code>', '<code>' . $field_id . '</code>' ), 'error' );
...
if ( ! function_exists( 'ot_admin_scripts' ) ) {
  ...
  function ot_admin_scripts() {
    ...
    if ( OT_META_BOXES == true && OT_POST_FORMATS == true ) {
      ...
      wp_enqueue_script( 'ot-postformats', OT_URL . 'assets/js/ot-postformats.js', array( 'jquery' ), '1.0.2' );
    ...
    $localized_array = array( 
      ...
      'upload_text'           => apply_filters( 'ot_upload_text', __( 'Send to OptionTree', 'pergo' ) ),

      'remove_media_text'     => __( 'Remove Media', 'pergo' ),

      'reset_agree'           => __( 'Are you sure you want to reset back to the defaults?', 'pergo' ),

      'remove_no'             => __( 'You can\'t remove this! But you can edit the values.', 'pergo' ),

      'remove_agree'          => __( 'Are you sure you want to remove this?', 'pergo' ),

      'activate_layout_agree' => __( 'Are you sure you want to activate this layout?', 'pergo' ),

      'setting_limit'         => __( 'Sorry, you can\'t have settings three levels deep.', 'pergo' ),

      'delete'                => __( 'Delete Gallery', 'pergo' ), 

      'edit'                  => __( 'Edit Gallery', 'pergo' ), 

      'create'                => __( 'Create Gallery', 'pergo' ), 

      'confirm'               => __( 'Are you sure you want to delete this Gallery?', 'pergo' ),

      'date_current'          => __( 'Today', 'pergo' ),

      'date_time_current'     => __( 'Now', 'pergo' ),

      'date_close'            => __( 'Close', 'pergo' ),

      'replace'               => __( 'Featured Image', 'pergo' ),
...
if ( ! function_exists( 'ot_get_media_post_ID' ) ) {
  ...
  function ot_get_media_post_ID() {
    ...
    if ( $post_ID === false || empty( $post_ID ) ) {
      ...
      $post_ID = $wpdb->get_var( "SELECT ID FROM $wpdb->posts WHERE `post_title` = 'Media' AND `post_type` = 'pergo' AND `post_status` = 'private'" );
...
if ( ! function_exists( 'ot_create_media_post' ) ) {
  ...
  function ot_create_media_post() {
    ...
    $regsiter_post_type( 'option-tree', array(
      'labels'              => array( 'name' => __( 'Option Tree', 'pergo' ) ),
      'public'              => false,
      'show_ui'             => false,
        ...
        $settings = array(
          ...
          'settings' => array(
            ...
            array(
              ...
              'label'     => __( 'Sample Text Field Label', 'pergo' ),

              'desc'      => __( 'Description for the sample text field.', 'pergo' ),
  ...
  function ot_alert_message( $page = array() ) {
    ...
    if ( $action == 'save-settings' ) {
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . __( 'Settings updated.', 'pergo' ) . '</p></div>';
        ...
        return '<div id="message" class="error fade below-h2"><p>' . __( 'Settings could not be saved.', 'pergo' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . __( 'Settings Imported.', 'pergo' ) . '</p></div>';
        ...
        return '<div id="message" class="error fade below-h2"><p>' . __( 'Settings could not be imported.', 'pergo' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . __( 'Data Imported.', 'pergo' ) . '</p></div>';
        ...
        return '<div id="message" class="error fade below-h2"><p>' . __( 'Data could not be imported.', 'pergo' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . __( 'Layouts Imported.', 'pergo' ) . '</p></div>';
        ...
        return '<div id="message" class="error fade below-h2"><p>' . __( 'Layouts could not be imported.', 'pergo' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . __( 'Layouts Updated.', 'pergo' ) . '</p></div>';
        ...
        return '<div id="message" class="error fade below-h2"><p>' . __( 'Layouts could not be updated.', 'pergo' ) . '</p></div>';
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . __( 'Layouts have been deleted.', 'pergo' ) . '</p></div>';
      ...
      return '<div id="message" class="updated fade below-h2"><p>' . __( 'Layout activated.', 'pergo' ) . '</p></div>';
...
if ( ! function_exists( 'ot_option_types_array' ) ) {
  ...
  function ot_option_types_array() {
    ...
    return apply_filters( 'ot_option_types_array', array( 
      ...
      'background'                => __('Background', 'pergo'),

      'border'                    => __('Border', 'pergo'),

      'box-shadow'                => __('Box Shadow', 'pergo'),

      'category-checkbox'         => __('Category Checkbox', 'pergo'),

      'category-select'           => __('Category Select', 'pergo'),

      'checkbox'                  => __('Checkbox', 'pergo'),

      'colorpicker'               => __('Colorpicker', 'pergo'),

      'colorpicker-opacity'       => __('Colorpicker Opacity', 'pergo'),

      'css'                       => __('CSS', 'pergo'),

      'custom-post-type-checkbox' => __('Custom Post Type Checkbox', 'pergo'),

      'custom-post-type-select'   => __('Custom Post Type Select', 'pergo'),

      'date-picker'               => __('Date Picker', 'pergo'),

      'date-time-picker'          => __('Date Time Picker', 'pergo'),

      'dimension'                 => __('Dimension', 'pergo'),

      'gallery'                   => __('Gallery', 'pergo'),

      'google-fonts'              => __('Google Fonts', 'pergo'),

      'javascript'                => __('JavaScript', 'pergo'),

      'link-color'                => __('Link Color', 'pergo'),

      'list-item'                 => __('List Item', 'pergo'),

      'measurement'               => __('Measurement', 'pergo'),

      'numeric-slider'            => __('Numeric Slider', 'pergo'),

      'on-off'                    => __('On/Off', 'pergo'),

      'page-checkbox'             => __('Page Checkbox', 'pergo'),

      'page-select'               => __('Page Select', 'pergo'),

      'post-checkbox'             => __('Post Checkbox', 'pergo'),

      'post-select'               => __('Post Select', 'pergo'),

      'radio'                     => __('Radio', 'pergo'),

      'radio-image'               => __('Radio Image', 'pergo'),

      'select'                    => __('Select', 'pergo'),

      'sidebar-select'            => __('Sidebar Select',  'pergo'),

      'slider'                    => __('Slider', 'pergo'),

      'social-links'              => __('Social Links', 'pergo'),

      'spacing'                   => __('Spacing', 'pergo'),

      'tab'                       => __('Tab', 'pergo'),

      'tag-checkbox'              => __('Tag Checkbox', 'pergo'),

      'tag-select'                => __('Tag Select', 'pergo'),

      'taxonomy-checkbox'         => __('Taxonomy Checkbox', 'pergo'),

      'taxonomy-select'           => __('Taxonomy Select', 'pergo'),

      'text'                      => __('Text', 'pergo'),

      'textarea'                  => __('Textarea', 'pergo'),

      'textarea-simple'           => __('Textarea Simple', 'pergo'),

      'textblock'                 => __('Textblock', 'pergo'),

      'textblock-titled'          => __('Textblock Titled', 'pergo'),

      'typography'                => __('Typography', 'pergo'),

      'upload'                    => __('Upload', 'pergo')
  ...
  function ot_radio_images( $field_id = '' ) {
    ...
    return apply_filters( 'ot_radio_images', array(
      ...
      array(
        ...
        'label'   => __( 'Full Width (no sidebar)', 'pergo' ),
  ...
  function ot_social_links_settings( $id ) {
    ...
    $settings = apply_filters( 'ot_social_links_settings', array(
      ...
      array(
        ...
        'desc'      => __( 'Enter the name of the social website.', 'pergo' ),
      ...
      array(
        ...
        'desc'      => __( 'Enter the text shown in the title attribute of the link.', 'pergo' ),
      ...
      array(
        ...
        'desc'      => sprintf( __( 'Enter a link to the profile or page on the social website. Remember to add the %s part to the front of the link.', 'pergo' ), '<code>http://</code>' ),
  ...
  function ot_insert_css_with_markers( $field_id = '', $insertion = '', $meta = false ) {
    ...
    if ( file_exists( $filepath ) ) {
      ...
      if ( ! is_writable( $filepath ) ) {
        ...
        add_settings_error( 'pergo', 'dynamic_css', sprintf( __( 'Unable to write to file %s.', 'pergo' ), '<code>' . $filepath . '</code>' ), 'error' );
  ...
  function ot_sections_view( $name, $key, $section = array() ) {
    ...
    <div class="option-tree-setting is-section">
      ...
      <div class="button-section">
        ...
        <a href="javascript:void(0);" class="option-tree-setting-edit option-tree-ui-button button left-item" title="' . __( 'edit', 'pergo' ) . '">

          <span class="icon ot-icon-pencil"></span>' . __( 'Edit', 'pergo' ) . '

        </a>

        <a href="javascript:void(0);" class="option-tree-setting-remove option-tree-ui-button button button-secondary light right-item" title="' . __( 'Delete', 'pergo' ) . '">

          <span class="icon ot-icon-trash-o"></span>' . __( 'Delete', 'pergo' ) . '
      ...
      <div class="option-tree-setting-body">
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-text">
            ...
            <div class="description">' . __( '<strong>Section Title</strong>: Displayed as a menu item on the Theme Options page.', 'pergo' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-text">
            ...
            <div class="description">' . __( '<strong>Section ID</strong>: A unique lower case alphanumeric string, underscores allowed.', 'pergo' ) . '</div>
      ...
      <div class="option-tree-setting-body">
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-text wide-desc">
            ...
            <div class="description">' . __( '<strong>Label</strong>: Displayed as the label of a form element on the Theme Options page.', 'pergo' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-text wide-desc">
            ...
            <div class="description">' . __( '<strong>ID</strong>: A unique lower case alphanumeric string, underscores allowed.', 'pergo' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-select wide-desc">
            ...
            <div class="description">' . __( '<strong>Type</strong>: Choose one of the available option types from the dropdown.', 'pergo' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-textarea wide-desc">
            ...
            <div class="description">' . __( '<strong>Description</strong>: Enter a detailed description for the users to read on the Theme Options page, HTML is allowed. This is also where you enter content for both the Textblock & Textblock Titled option types.', 'pergo' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-textblock wide-desc">
            ...
            <div class="description">' . __( '<strong>Choices</strong>: This will only affect the following option types: Checkbox, Radio, Select & Select Image.', 'pergo' ) . '</div>
            ...
            <div class="format-setting-inner">
              ...
              <a href="javascript:void(0);" class="option-tree-choice-add option-tree-ui-button button hug-left">' . __( 'Add Choice', 'pergo' ) . '</a>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-textblock wide-desc">
            ...
            <div class="description">' . __( '<strong>Settings</strong>: This will only affect the List Item option type.', 'pergo' ) . '</div>
            ...
            <div class="format-setting-inner">
              ...
              <a href="javascript:void(0);" class="option-tree-list-item-setting-add option-tree-ui-button button hug-left">' . __( 'Add Setting', 'pergo' ) . '</a>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-text wide-desc">
            ...
            <div class="description">' . __( '<strong>Standard</strong>: Setting the standard value for your option only works for some option types. Read the <code>OptionTree->Documentation</code> for more information on which ones.', 'pergo' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-text wide-desc">
            ...
            <div class="description">' . __( '<strong>Rows</strong>: Enter a numeric value for the number of rows in your textarea. This will only affect the following option types: CSS, Textarea, & Textarea Simple.', 'pergo' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-text wide-desc">
            ...
            <div class="description">' . __( '<strong>Post Type</strong>: Add a comma separated list of post type like \'post,page\'. This will only affect the following option types: Custom Post Type Checkbox, & Custom Post Type Select.', 'pergo' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-text wide-desc">
            ...
            <div class="description">' . __( '<strong>Taxonomy</strong>: Add a comma separated list of any registered taxonomy like \'category,post_tag\'. This will only affect the following option types: Taxonomy Checkbox, & Taxonomy Select.', 'pergo' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-text wide-desc">
            ...
            <div class="description">' . __( '<strong>Min, Max, & Step</strong>: Add a comma separated list of options in the following format <code>0,100,1</code> (slide from <code>0-100</code> in intervals of <code>1</code>). The three values represent the minimum, maximum, and step options and will only affect the Numeric Slider option type.', 'pergo' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-text wide-desc">
            ...
            <div class="description">' . __( '<strong>CSS Class</strong>: Add and optional class to this option type.', 'pergo' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-select wide-desc">
            ...
            <div class="description">' . __( '<strong>Operator</strong>: Choose the logical operator to compute the result of the conditions.', 'pergo' ) . '</div>

            <div class="format-setting-inner">

              <select name="' . esc_attr( $name ) . '[' . esc_attr( $key ) . '][operator]" value="' . $operator . '" class="option-tree-ui-select">

                <option value="and" ' . selected( $operator, 'and', false ) . '>' . __( 'and', 'pergo' ) . '</option>

                <option value="or" ' . selected( $operator, 'or', false ) . '>' . __( 'or', 'pergo' ) . '</option>
      ...
      <div class="option-tree-setting-body">
        ...
        <div class="format-settings">
          ...
          <div class="format-setting-label">
            ...
            <h5>' . __( 'Image Source (Radio Image only)', 'pergo' ) . '</h5>
      ...
      <div class="option-tree-setting-body">
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-text no-desc">
            ...
            <div class="description">' . __( '<strong>Title</strong>: Displayed as a contextual help menu item on the Theme Options page.', 'pergo' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-textarea no-desc">
            ...
            <div class="description">' . __( '<strong>Content</strong>: Enter the HTML content about this contextual help item displayed on the Theme Option page for end users to read.', 'pergo' ) . '</div>
...
if ( ! function_exists( 'ot_layout_view' ) ) {
  ...
  function ot_layout_view( $key, $data = '', $active_layout = '' ) {
    ...
    <div class="option-tree-setting">
      ...
      <div class="open">' . ( isset( $key ) ? esc_attr( $key ) : __( 'Layout', 'pergo' ) ) . '</div>

      <div class="button-section">

        <a href="javascript:void(0);" class="option-tree-layout-activate option-tree-ui-button button left-item' . ( $active_layout == $key ? ' active' : '' ) . '" title="' . __( 'Activate', 'pergo' ) . '">

          <span class="icon ot-icon-square-o"></span>' . __( 'Activate', 'pergo' ) . '
  ...
  function ot_list_item_view( $name, $key, $list_item = array(), $post_id = 0, $get_option = '', $settings = array(), $type = '' ) {
    ...
    <div class="option-tree-setting">
      ...
      foreach( $settings as $field ) {
        ...
        /* build the arestructuraents array */
  ...
  function ot_theme_options_layouts_form( $active = false ) {
    ...
    echo '<form method="post" id="option-tree-options-layouts-form">';
      ...
      echo '<div class="option-tree-save-layout' . ( ! empty( $active_layout ) ? ' active-layout' : '' ) . '">';
        ...
        echo '<button type="submit" class="option-tree-ui-button button button-primary save-layout" title="' . __( 'New Layout', 'pergo' ) . '">' . __( 'New Layout', 'pergo' ) . '</button>';
...
function ot_fetch_google_fonts( $normalize = true, $force_rebuild = false ) {
  ...
  //remove_theme_mod( 'ot_google_fonts' );
  ...
  if ( $force_rebuild || ! is_array( $ot_google_fonts ) || empty( $ot_google_fonts ) ) {
    ...
    $ot_google_fonts_query_args = array(
      ...
      'sort'   => $ot_google_fonts_sort
        ...
        $ot_google_fonts_data = json_decode( trim( pergo_get_google_fonts_array() ), true );
  ...
  return apply_filters( 'ot_meta_box_post_format_quote', array(
    ...
    'fields'    => array(
      ...
      array(
        ...
        'desc'    => __( 'Source Name (ex. author, singer, actor)', 'pergo' ),
      ...
      array(
        ...
        'desc'    => __( 'Source Title (ex. book, song, movie)', 'pergo' ),
  ...
  return apply_filters( 'ot_meta_box_post_format_video', array(
    ...
    'fields'    => array(
      ...
      array(
        ...
        'desc'    => sprintf( __( 'Embed video from services like Youtube, Vimeo, or Hulu. You can find a list of supported oEmbed sites in the %1$s. Alternatively, you could use the built-in %2$s shortcode.', 'pergo' ), '<a href="http://codex.wordpress.org/Embeds" target="_blank">' . __( 'Wordpress Codex', 'pergo' ) .'</a>', '<code>[video]</code>' ),
  ...
  return apply_filters( 'ot_meta_box_post_format_audio', array(
    ...
    'fields'    => array(
      ...
      array(
        ...
        'desc'    => sprintf( __( 'Embed audio from services like SoundCloud and Rdio. You can find a list of supported oEmbed sites in the %1$s. Alternatively, you could use the built-in %2$s shortcode.', 'pergo' ), '<a href="http://codex.wordpress.org/Embeds" target="_blank">' . __( 'Wordpress Codex', 'pergo' ) .'</a>', '<code>[audio]</code>' ),
