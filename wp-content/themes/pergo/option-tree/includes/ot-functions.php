...
* @since     2.1
*/
if (!function_exists('ot_register_theme_options_adminbar_menu')) {
    function ot_register_theme_options_adminbar_menu($wp_admin_bar){
        ...
        $wp_admin_bar->add_node(array(
            ...
            'title' => apply_filters('ot_theme_options_page_title', __('Theme Options', 'pergo')),
