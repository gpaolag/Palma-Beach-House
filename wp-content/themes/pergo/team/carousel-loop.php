<?php if ( $posts->have_posts() ):  
	...
	?>
	<div class="team-slider owl-carousel owl-theme" id="team-1" data-loop="0" data-autoplay="<?php echo ($autoplay == 'yes')? 1 : 0 ?>" data-dots="<?php echo ($dots == 'yes')? 1 : 0 ?>" data-column_lg="<?php echo $column; ?>">               
		<?php
		$count = 1;
		while ( $posts->have_posts() ) :
			...
			global $post;
			?>					
				<div class="item animated" data-animation="fadeInUp" data-animation-delay="<?php echo intval($animation_duration) ?>">
					<div class="team-member white-color">
					    <!-- Team Member Photo -->					    
					    <img src="<?php the_post_thumbnail_url( 'pergo-400x400-crop' ); ?>" class="img-fluid" alt="<?php the_title_attribute(); ?>">	
		...
		<?php endwhile; ?>	
		<?php get_template_part( 'team/carousel-hiring' ); ?>		
	</div> <!-- .row -->
	<?php	
// Posts not found
else :
