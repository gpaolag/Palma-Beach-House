...
* The VC Functions
*/
add_action( 'vc_before_init', 'pergo_about_us_shortcode_vc' );
function pergo_about_us_shortcode_vc( $return = false ) {
    $args = array(
         'icon' => 'pergo-icon',
        'name' => __( 'About us', 'pergo' ),
        'base' => 'pergo_about_us',
        'class' => 'pergo-vc',
        'category' => __( 'Pergo', 'pergo' ),
        'description' => __( 'Display image, title, description & counter ', 'pergo' ),
        'params' => array(
            array(
                'type' => 'checkbox',
            ...
            array(
                ...
                'param_name' => 'image',
                'description' => '',
                'value' => PERGO_URI . '/images/image-01.png',
            ...
            array(
                ...
                'description' => '',
                'value' => 'Egestas magna egestas magna ipsum vitae purus ipsum primis in cubilia augue luctus magna',
                'admin_label' => true 
            ),
            array(
                 'type' => 'textarea_html',
...
class WPBakeryShortCode_Pergo_about_us extends WPBakeryShortCode {
}