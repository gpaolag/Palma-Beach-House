...
*/
add_action( 'vc_before_init', 'pergo_section_title_shortcode_vc' );
function pergo_section_title_shortcode_vc( $return = false ) {
    $args = array(
        'icon' => 'pergo-icon',
        'name' => __( 'Section title', 'pergo' ),
        'base' => 'pergo_section_title',
        'class' => 'pergo-vc',
...
class WPBakeryShortCode_Pergo_section_title extends WPBakeryShortCode {
}