...
*/
add_action( 'delete_attachment', 'pergo_delete_resized_images' );
function pergo_image_resize( $url, $width = null, $height = null, $crop = true, $align = 'c', $retina = false ) {
    global $wpdb;
    // Get common vars (func_get_args() only get specified values)
    $common = pergo_common_info( $url, $width, $height, $crop, $align, $retina );
...
function pergo_common_info( $url, $width, $height, $crop, $align, $retina ) {
...
function pergo_delete_resized_images( $post_id ) {
