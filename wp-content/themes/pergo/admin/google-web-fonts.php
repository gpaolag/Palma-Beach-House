<?php
add_action( 'init', 'pergo_google_fonts_init' );
function pergo_google_fonts_init(){
    $ot_google_fonts_cache_key = 'pergoperchdevelopment';
    $ot_set_google_fonts  = get_theme_mod( 'ot_google_fonts', array() );
    if(empty($ot_set_google_fonts)) return false;
...
function pergo_get_google_fonts_array(){
$pergo_fonts ='{
